...
__C.DIR.HSITE_TRAIN = './Dataset/Historical_Sites/train'
__C.DIR.HSITE_TEST = './Dataset/Historical_Sites/test'
__C.DIR.SHNET_TRAIN = './Dataset/ShapeNetCore/%s/train'
__C.DIR.SHNET_TEST = './Dataset/ShapeNetCore/%s/test'
__C.DIR.OUT_PATH = './output'
__C.DIR.CKPT_PATH = './output/ResidualGRUNet/default_model/checkpoint.pth'
